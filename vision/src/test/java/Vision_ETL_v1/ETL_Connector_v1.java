...
public class ETL_Connector_v1 extends BaseClass {
	String Connector_SendKeys = "VAT_Auto_test33";
	String IP = "10.16.1.38";
	String port_int = "52866";
	String FilePath = ("D:\\Guru prasad documents\\sel.tz.reconfile.csv");
	String Semi = "VAT_Upload";
	...
	public void ETL_CC_026(String loginName, String loginPwd) throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//span[contains(text(),'RA_STG_01 - RA_STAGING')]")).click();// --
																											// Connector
																											// ID
																											// Select---//
		driver.findElement(By.xpath(
	...
	@TestDescription("After click on Reject previous state of record should be displayed, Empty table should not occur")
	public void ETL_CC_036(String loginName, String loginPwd) throws InterruptedException {
        ...
        String notes = "After click on Reject previous state of record should be displayed, Empty table should not occur";
        ListenersETL.reportTestDetails1(ScreenName,testCaseId, notes);
		driver.findElement(By.xpath(
				"//body/app-root[1]/app-login[1]/div[1]/div[1]/div[1]/div[2]/div[2]/form[1]/span[2]/div[1]/input[1]"))
				.sendKeys(loginName);
