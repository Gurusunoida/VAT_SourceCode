...
public class ETLConnector extends BaseClass{
	...
	public void ETL_CC_009(String loginName, String loginPwd) throws InterruptedException {
		...
		driver.findElement(By.xpath(
				...
				.click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//span[contains(text(),'101_ORACLE - 101_ORACLE')]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath(
...
//				.click();// -- Filter Colum Click--//
	...
	public void ETL_CC_028(String loginName, String loginPwd) throws InterruptedException {
		...
		driver.findElement(By.xpath("//body/ngb-modal-window[1]/div[1]/div[1]/app-smart-search[1]/div[2]/form[1]/perfect-scrollbar[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[3]/div[1]/input[1]")).sendKeys("VAT_KENYA");
		driver.findElement(By.xpath("//button[contains(text(),'Apply')]")).click();
		Thread.sleep(5000);
		Thread.sleep(3000);// --Drop down of Connector
