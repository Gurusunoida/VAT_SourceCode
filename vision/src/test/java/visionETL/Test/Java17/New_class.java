...
public class New_class implements ITestListener {
    ...
    private static final String REPORTS_PATH = System.getProperty("user.dir") + "\\Reports\\VAT_Report_Dummy_ETL.html";
    private static final String SCREENSHOTS_DIR = System.getProperty("user.dir") + "\\Screenshots\\";
    private static final String SCREENSHOT_PATH = System.getProperty("user.dir") + "\\test-output\\Screenshot\\ETL\\";
