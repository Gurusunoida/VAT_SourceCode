...
//	        //-- save the screenshot --//
//	        File destinationFile = new File("ETL_DC_009.png");
...
//	        File screenshotFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
//	        //-- save the screenshot --//
//	        File destinationFile = new File("ETL_DC_013.png");
//	        // Move the screenshot file to the specified destination
//	        try {
//	            org.apache.commons.io.FileUtils.copyFile(screenshotFile, destinationFile);
...
//			 //-- Take screenshot and save it to a file--//
//			File screenshotFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
//			String Location = "D:\\Source code\\vision\\test-output\\Screenshot\\ETL_DC_005.png";
//			//-- save the screenshot --//
...
//			String Location1 = "D:\\Source code\\vision\\test-output\\Screenshot\\ETL_DC_005_1.png";
//			//-- save the screenshot --//
...
//			driver.findElement(By.xpath("//button[contains(text(),'Apply')]")).click();
//			Thread.sleep(2000);
//			WebElement elemet_to_Hover = driver.findElement(By.xpath("//span[contains(text(),'MJtest9')]"));
