...
//		driver.findElement(By.xpath("//i[contains(text(),'chevron_right')]")).click();
//		Thread.sleep(5000);
//		driver.findElement(By.xpath("/html[1]/body[1]/app-root[1]/app-main-container[1]/div[1]/div[2]/div[1]/app-category[1]/div[1]/div[1]/div[1]/div[1]/app-smart-table[1]/div[2]/perfect-scrollbar[1]/div[1]/div[1]/table[1]/tbody[1]/tr[2]/td[6]/div[2]/a[3]/i[1]")).click();        
//		Thread.sleep(3000);
//		/////----------- Still Coding in Progress----------//////
//		}
...
//////		driver.findElement(By.cssSelector("body.sidebar-mini.body-background:nth-child(2) div.wrapper div.main-panel.ps-container.content-area_bound:nth-child(3) div.content-area:nth-child(2) app-category.ng-star-inserted:nth-child(2) div.card-body.material-table.p-0 div.row.m-0 div.col-sm-12.col-md-12.col-lg-12.col-xl-12.h-100.p-0 div.material-table.dashboard-bg-white.b-radius-12.h-100.mt-0 app-smart-table.ng-tns-c285-4.ng-star-inserted div.table-responsive.ng-tns-c285-4 perfect-scrollbar.ng-tns-c285-4.ng-star-inserted div.ps div.ps-content table.inlineEditTable tbody.ng-tns-c285-4.ng-star-inserted:nth-child(2) tr.ng-tns-c285-4.ng-star-inserted:nth-child(1) td.ng-tns-c285-4.ng-star-inserted:nth-child(6) div.tr-edit-icons.row.a1.ng-tns-c285-4.ng-star-inserted a.modal-trigger.waves-effect.btn-flat.nopadding.pr-2.ng-tns-c285-4.ng-star-inserted:nth-child(3) > i.material-icons.ng-tns-c285-4")).click();
//////		Thread.sleep(3000);
////		driver.findElement(By.xpath("//tbody/tr[@id='highLightRow0']/td[6]/div[2]/a[2]/i[1]")).click();
////		Thread.sleep(2000);
...
////		driver.findElement(By.xpath("/html[1]/body[1]/app-root[1]/app-main-container[1]/div[1]/div[2]/div[1]/app-category[1]/div[1]/div[1]/div[1]/div[1]/app-smart-table[1]/div[2]/perfect-scrollbar[1]/div[1]/div[1]/table[1]/tbody[1]/tr[1]/td[6]/div[2]/a[6]/i[1]")).click();
////		Thread.sleep(3000);
////		
////		----------------Still Coding in Progress-------------(for Reject)
////		}
