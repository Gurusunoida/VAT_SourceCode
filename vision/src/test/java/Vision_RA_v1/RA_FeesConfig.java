...
//	}
	...
	public void VAT_FEE_DC_003(String username, String password) throws InterruptedException {
		...
		driver.findElement(By.xpath(
				"//body/app-root[1]/app-main-container[1]/div[1]/div[2]/ng-dropdown-panel[1]/div[1]/div[2]/div[1]/span[1]/span[1]"))
				.click();
		Thread.sleep(5000);
		// -- Tier Range type drop down--//
		driver.findElement(By.xpath(
	...
	public void VAT_FEE_DC_004(String username, String password) throws InterruptedException {
		...
		Thread.sleep(5000);
		//-- Add row click--//		
		driver.findElement(By.xpath("//body/app-root[1]/app-main-container[1]/div[1]/div[2]/div[1]/app-transaction-line-module[1]/div[1]/div[1]/div[1]/div[1]/div[1]/app-fees-line-transaction[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[3]/div[2]/div[1]/div[3]/a[2]/div[1]")).click();
		Thread.sleep(5000);
	...
	public void VAT_FEE_DC_017(String username, String password) throws InterruptedException {
		...
		driver.findElement(By.xpath("//span[contains(text(),'Fees Configuration')]")).click();
		Thread.sleep(5000);// -- Fees Config Button Click--//
		//--particular fees click--//
		driver.findElement(By.xpath("//td[contains(text(),'14-Aug-2024 12:38:47')]")).click();
		Thread.sleep(3000);
		//--preferential click--//
		driver.findElement(By.xpath("//span[contains(text(),'Preferential')]")).click();
		Thread.sleep(3000);
...
//		driver.findElement(By.xpath("//body/app-root[1]/app-main-container[1]/div[1]/div[2]/div[1]/app-transaction-line-module[1]/div[1]/div[1]/div[1]/div[1]/div[1]/app-fees-line-transaction[1]/div[1]/div[2]/div[2]/button[1]")).click();
//		Thread.sleep(2000);
//		WebElement elementToHoverM = driver.findElement(By.xpath("//body[1]/app-root[1]/app-main-container[1]/div[1]/div[2]/div[1]/app-transaction-line-module[1]/div[1]/div[1]/div[1]/div[1]/div[1]/app-fees-line-transaction[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[3]/div[2]/div[2]/perfect-scrollbar[1]/div[1]/div[1]/div[1]/table[1]/tbody[1]/tr[2]/td[3]"));
//		Actions actionsClick = new Actions(driver);
//		actionsClick.moveToElement(elementToHoverM).perform();
//		WebElement FeesConfig = driver.findElement(By.xpath("//tbody/tr[2]/td[46]/div[1]/div[1]/a[1]/i[1]"));
//		FeesConfig.click();
//		Thread.sleep(2000);
//		//-- Apply Click--//
//		driver.findElement(By.xpath("//button[contains(text(),'Apply')]")).click();
