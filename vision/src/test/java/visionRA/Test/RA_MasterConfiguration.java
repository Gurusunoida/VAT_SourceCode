...
//	}
	...
	public void RA_MC_007(String username, String password) throws InterruptedException {
		...
		Thread.sleep(2000);
		WebElement elementToHoverM = driver.findElement(By.xpath("//body/app-root[1]/app-main-container[1]/div[1]/div[2]/div[1]/app-recon-config[1]/div[1]/div[1]/div[3]/div[1]/div[2]/div[2]/div[2]/form[1]/div[1]/perfect-scrollbar[1]/div[1]/div[1]/div[2]/div[1]/div[2]/span[2]/i[1]"));
		Actions actionsClick = new Actions(driver);
		actionsClick.moveToElement(elementToHoverM).perform();
		WebElement Connector = driver.findElement(By.xpath("//body/app-root[1]/app-main-container[1]/div[1]/div[2]/div[1]/app-recon-config[1]/div[1]/div[1]/div[3]/div[1]/div[2]/div[2]/div[2]/form[1]/div[1]/perfect-scrollbar[1]/div[1]/div[1]/div[2]/div[1]/div[2]/span[2]/i[1]"));
		Thread.sleep(2000);	
		//-- Take screenshot and save it to a file--//
		File screenshotFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
