...
//				.click();
		...
		WebElement Dup_AlphaTab = driver
				.findElement(By.xpath("//p[contains(text(),'- Failed - Duplicate key insertio')]"));
	...
	public void ALP_TAB_004_ALP_TAB_003(String username, String password) throws InterruptedException {
		...
		String notes = "After clicking on Delete entire record should move to Delete pending" + DeleteSuccess
				+ RejectSuccess;
		ListenersRA.reportTestDetails1(ScreenName, testCaseId, notes);
	}
...
//		driver.findElement(By.xpath("//tbody/tr[1]/td[11]/div[1]/div[1]/input[1]")).sendKeys(AlphaSubTab1);
	...
	public void ALP_NUM_015(String username, String password) throws InterruptedException {
		...
		// -- Num tab click--//
		driver.findElement(By.xpath(
				"//body/app-root[1]/app-main-container[1]/div[1]/div[2]/div[1]/app-alphanumtab[1]/div[1]/div[1]/div[1]/div[1]/div[1]/ul[1]/li[2]/span[1]"))
				.click();
		Thread.sleep(3000);
		// -- Add Click--//
		General.ADD();
...
//		driver.findElement(By.xpath("//button[contains(text(),'Save')]")).click();
		...
		String SuccessText = Success.getText();
		System.out.println(SuccessText);
		String notes = "Click on add and create a record and click on save	The created record should save successfully"
				+ "_" + SuccessText;
		ListenersRA.reportTestDetails1(ScreenName, testCaseId, notes);
		Thread.sleep(2000);
	}
	...
	public void ALP_NUM_023(String username, String password) throws InterruptedException {
		...
		EditClick.click();
		Thread.sleep(2000);
		WebElement elementToHoverM1 = driver.findElement(By
				.xpath("//tbody/tr[1]/td[12]/div[1]/div[1]/div[1]/div[1]/ng-select[1]/div[1]/div[1]/div[3]/input[1]"));
		Actions actionsClick1 = new Actions(driver);
		actionsClick1.moveToElement(elementToHoverM1).perform();
		WebElement Status = driver
				.findElement(By.xpath("//tbody/tr[1]/td[12]/div[1]/div[1]/div[1]/div[1]/ng-select[1]/div[1]/span[2]"));
		Status.click();
		Thread.sleep(2000);
		...
		WebElement Success = driver
				.findElement(By.xpath("//div[contains(text(),'Addition of only active record is allowed')]"));
		String SuccessText = Success.getText();
		System.out.println(SuccessText);
		// -- Take screenshot and save it to a file--//
		File screenshotFile = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
...
//		driver.findElement(By.xpath("//tbody/tr[1]/td[11]/div[1]/div[1]/input[1]")).sendKeys(AlphaSubTab);
	...
	public void ALP_NUM_026(String username, String password) throws InterruptedException {
		...
		for (int ALPHA_NUM = 1; ALPHA_NUM <= 4; ALPHA_NUM++) {
			...
			driver.findElement(By.xpath(
					"//body/app-root[1]/app-main-container[1]/div[1]/div[2]/div[1]/app-alphanumtab[1]/div[1]/div[1]/div[1]/div[1]/app-alphatab[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[1]/input[1]"))
					.sendKeys(AlphaTabReject + ALPHA_NUM);
			// -- description send keys--//
			driver.findElement(By.xpath(
					"//body/app-root[1]/app-main-container[1]/div[1]/div[2]/div[1]/app-alphanumtab[1]/div[1]/div[1]/div[1]/div[1]/app-alphatab[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[2]/input[1]"))
					.sendKeys(AlphasubReject);
			Thread.sleep(2000);
			// --Alpha Sub tab send keys--//
			WebElement ALPHASUBTAB = driver.findElement(By.xpath("//tbody/tr[1]/td[10]/div[1]/div[1]/input[1]"));
			ALPHASUBTAB.click();
		...
		// -- Reject click--//
		driver.findElement(By.xpath(
				"//body/app-root[1]/app-main-container[1]/div[1]/div[2]/div[1]/app-alphanumtab[1]/div[1]/div[1]/div[1]/div[1]/app-alphatab[1]/div[1]/div[1]/div[1]/div[1]/app-smart-table[1]/div[1]/div[1]/a[2]/i[1]"))
				.click();
		// -- Yes click--//
		driver.findElement(By.xpath("//button[contains(text(),'Yes')]")).click();
		Thread.sleep(2000);
		...
		String notes = "Click on Select records and  Bulk Reject ,	All the selected records should be rejected" + ","
				+ Reject;
		ListenersRA.reportTestDetails1(ScreenName, testCaseId, notes);
		Thread.sleep(5000);
		// -- Num tab click--//
		...
		for (int NUMTAB = 1; NUMTAB <= 3; NUMTAB++) {
			...
			driver.findElement(By.xpath(
					"//body/app-root[1]/app-main-container[1]/div[1]/div[2]/div[1]/app-alphanumtab[1]/div[1]/div[1]/div[1]/div[1]/app-numtab[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[1]/input[1]"))
					.sendKeys(NumTabReject + NUMTAB);
			// -- description send keys--//
			driver.findElement(By.xpath(
					"//body/app-root[1]/app-main-container[1]/div[1]/div[2]/div[1]/app-alphanumtab[1]/div[1]/div[1]/div[1]/div[1]/app-numtab[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[2]/input[1]"))
					.sendKeys(NumSubTabReject);
			Thread.sleep(2000);
			// --Num Sub tab send keys--//
			WebElement NumSUBTAB = driver.findElement(By.xpath("//tbody/tr[1]/td[10]/div[1]/div[1]/input[1]"));
			NumSUBTAB.click();
		...
		// -- Reject click--//
		driver.findElement(By.xpath(
				"//body/app-root[1]/app-main-container[1]/div[1]/div[2]/div[1]/app-alphanumtab[1]/div[1]/div[1]/div[1]/div[1]/app-numtab[1]/div[1]/div[1]/div[1]/div[1]/app-smart-table[1]/div[1]/div[1]/a[2]/i[1]"))
				.click();
		// -- Yes click--//
		driver.findElement(By.xpath("//button[contains(text(),'Yes')]")).click();
		Thread.sleep(2000);
	...
	public void ALP_NUM_027(String username, String password) throws InterruptedException {
		...
		for (int ALPHA_NUM = 5; ALPHA_NUM <= 6; ALPHA_NUM++) {
			...
			driver.findElement(By.xpath(
					"//body/app-root[1]/app-main-container[1]/div[1]/div[2]/div[1]/app-alphanumtab[1]/div[1]/div[1]/div[1]/div[1]/app-alphatab[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[1]/input[1]"))
					.sendKeys(AlphaTabApprove + ALPHA_NUM);
			// -- description send keys--//
			driver.findElement(By.xpath(
					"//body/app-root[1]/app-main-container[1]/div[1]/div[2]/div[1]/app-alphanumtab[1]/div[1]/div[1]/div[1]/div[1]/app-alphatab[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[2]/input[1]"))
					.sendKeys(AlphaSubAprove);
			Thread.sleep(2000);
			// --Alpha Sub tab send keys--//
			WebElement ALPHASUBTAB = driver.findElement(By.xpath("//tbody/tr[1]/td[10]/div[1]/div[1]/input[1]"));
			ALPHASUBTAB.click();
		...
		for (int NUMTAB = 5; NUMTAB <= 6; NUMTAB++) {
			...
			driver.findElement(By.xpath(
					"//body/app-root[1]/app-main-container[1]/div[1]/div[2]/div[1]/app-alphanumtab[1]/div[1]/div[1]/div[1]/div[1]/app-numtab[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[1]/input[1]"))
					.sendKeys(NumTabApprove + NUMTAB);
			// -- description send keys--//
			driver.findElement(By.xpath(
					"//body/app-root[1]/app-main-container[1]/div[1]/div[2]/div[1]/app-alphanumtab[1]/div[1]/div[1]/div[1]/div[1]/app-numtab[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[2]/input[1]"))
					.sendKeys(NumSubTabApprove);
			Thread.sleep(2000);
			// --Num Sub tab send keys--//
			WebElement NumSUBTAB = driver.findElement(By.xpath("//tbody/tr[1]/td[10]/div[1]/div[1]/input[1]"));
			NumSUBTAB.click();
		...
		String notes = "Click on Select records and  Bulk Approve	All the selected records should be Approved" + ","
				+ AlphaApprove;
		ListenersRA.reportTestDetails1(ScreenName, testCaseId, notes);
		Thread.sleep(2000);
		// -- Num Tab Click--//
